...
--[[ STATIC METHODS ]]--
function Path.GetNearestCharacter(fromPosition, customDist)
	local character, dist = nil, customDist or math.huge
	for _, player in ipairs(Players:GetPlayers()) do
		if player.Character and player.Character.Humanoid.Health > 0 and (player.Character.PrimaryPart.Position - fromPosition).Magnitude < dist then
